          ...
          <Col className='body'>
            <div className='info'>
              <ol>
                ...
                <li><strong>What do I actually get when I buy a name?</strong> Everything. The name's Deed is transferred to the buyer, the name's resolver is set to the <a href='#' target='_blank'>ENS Public Resolver</a>, and the resolver is configured to direct payments sent to the purchased name to your ETH address.</li>
                ...
                <li><strong>Where can I donate?</strong> No donations necessary. The seller fees should be enough to keep the site running and the work developing the smart contracts was done for the betterment of the Ethereum community. Please consider instead donating to the <a href='#' target='_blank'>Ethereum developers</a>. But if you absolutely refuse to be turned away, you can send donations to 0x4e6a1c57cdbfd97e8efe831f8f4418b1f2a09e6e </li>
              </ol>
            </div>
          </Col>
        </Row>
